	...
	return (
		<article
			className={classNames(
				'works__item',
				isActive && 'works__item--active',
				hasDetail && 'works__item--clickable',
			)}
			ref={containerRef}
			onClick={handleClick}
		>
			...
			<div className='works__item__right'>
				<div className='works__item__right__header'>
					...
					{hasDetail && (
						<span className='works__item__right__header__arrow'>View Detail →</span>
					)}
				</div>
				...
				<p className='works__item__right__description'>{description}</p>
				<div className='works__item__right__tags flex flex-wrap'>
					{techStack.map(tech => (
						<span key={tech} className='works__item__right__tags__tag'>
							{tech}
						</span>
					))}
				</div>
